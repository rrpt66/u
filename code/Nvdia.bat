...
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Class\{4d36e968-e325-11ce-bfc1-08002be10318}\0001" /v "ExtEvent_BIOSEventByInterrupt" /t REG_DWORD /d "0" /f
